...
#
# CODE FROM: https://lunnova.dev/articles/stable-diffusion-ema-on-cpu/
#

class LitEmaCPU(nn.Module):
    def __init__(
        self,
        model,
        decay=0.9999,
        ...
        ema_on_cpu=True,
        update_every=100,
        accumulated_batch_gradients=80,
        verbose=True,
    ):
        super().__init__()
        ...
        if update_every:
            decay = math.pow(decay, update_every/accumulated_batch_gradients)

        self.verbose = verbose
        self.update_every = update_every # * accumulated_batch_gradients
        self.m_name2s_name = {}
