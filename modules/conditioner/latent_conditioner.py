...
from generative_models.sgm.modules.attention import MemoryEfficientCrossAttention
    ...
    def forward(
        ...
        for embedder in self.embedders:
            ...
            if not isinstance(emb_out, (list, tuple)):
                emb_out = [emb_out]
            for emb in emb_out:
                # TODO: Maybe change this to directly handle upsampled concat to noise and cross attention
                out_key = "crossattn"
